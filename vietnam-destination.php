...
<body id="main-body">
    ...
    <main class="main-content">
        <div class="site-w">
            <h1 class="main-title">Vietnam Destinations</h1>
            <div class="top-destinations">
                <div class="destinations-group">
                    <div class="destination-item page-description">
                    ...
                    <div class="destination-item">
                        ...
                        <div class="destination-desc">
                            <p><span class="title20">Ninh Binh</span><br>
                                +10 properties
                            </p>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-desc">
                            <p><span class="title20">Danang</span><br>
                                +10 properties
                            </p>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-desc">
                            <p><span class="title20">Phu Quoc island</span><br>
                                +12 properties
                            </p>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-desc">
                            <p><span class="title20">Can Tho</span><br>
                                +5 properties
                            </p>
                        </div>
                    </div>
                ...
                <div class="destinations-group">
                    <div class="destination-item">
                        ...
                        <div class="destination-desc">
                            <p><span class="title20">Hanoi</span><br>
                                +31 properties
                            </p>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-desc">
                            <p><span class="title20">Sapa</span><br>
                                +22 properties
                            </p>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-desc">
                            <p><span class="title20">Nha Trang</span><br>
                                +13 properties
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="destination-item">
                        ...
                        <div class="destination-desc">
                            <p><span class="title20">Mui Ne</span><br>
                                +6 properties
                            </p>
                        </div>
                    </div>
                ...
                <div class="destinations-group">
                    <div class="destination-item">
                        ...
                        <div class="destination-desc">
                            <p><span class="title20">Hue</span><br>
                                +15 properties
                            </p>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-desc">
                            <p><span class="title20">Hoi An</span><br>
                                +21 properties
                            </p>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-desc">
                            <p><span class="title20">Ho Chi Minh City</span><br>
                                +9 properties
                            </p>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-desc">
                            <p><span class="title20">Phong Nha - Ke Bang</span><br>
                                +4 properties
                            </p>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-desc">
                            <p><span class="title20">Da Lat</span><br>
                                +7 properties
                            </p>
                        </div>
                    </div>
